(function (root) {
    ...
    Pizzicato.Util = {
        ...
        isOscillator: function (audioNode) {
            return audioNode && audioNode.constructor === OscillatorNode;
        },

        isAudioBufferSourceNode: function (audioNode) {
            return audioNode && audioNode.constructor === AudioBufferSourceNode;
        },
        ...
        isEffect: function (effect) {
            for (var key in Pizzicato.Effects) {
                if (Pizzicato.Effects.hasOwnProperty(key) && effect instanceof Pizzicato.Effects[key]) {
                    return true;
                }
            }
            return false;
    ...
    Pizzicato.Events = {
        ...
        trigger: function (name) {
            ...
            var _event = this._events && this._events[name];
    ...
    Pizzicato.Effects.Delay = function (options) {
        ...
        this.feedback = options.feedback === undefined ? defaults.feedback : options.feedback;
        this.time = options.time === undefined ? defaults.time : options.time;
        this.mix = options.mix === undefined ? defaults.mix : options.mix;
    };
    ...
    Pizzicato.Effects.Delay.prototype = Object.create(baseEffect, {
        ...
        mix: {
            ...
            set: function (mix) {
                ...
                this.dryGainNode.gain.value = Pizzicato.Util.getDryLevel(mix);
                this.wetGainNode.gain.value = Pizzicato.Util.getWetLevel(mix);
            }
        },
        ...
        feedback: {
            ...
            set: function (feedback) {
                ...
                this.feedbackGainNode.gain.value = feedback;
            }
        }
    ...
    Pizzicato.Effects.Compressor = function (options) {
        ...
        this.threshold = options.threshold === undefined ? defaults.threshold : options.threshold;
        this.knee = options.knee === undefined ? defaults.knee : options.knee;
        this.attack = options.attack === undefined ? defaults.attack : options.attack;
        this.release = options.release === undefined ? defaults.release : options.release;
        this.ratio = options.ratio === undefined ? defaults.ratio : options.ratio;
    };
    ...
    function Filter(options, type) {
        ...
        this.frequency = options.frequency === undefined ? defaults.frequency : options.frequency;
        this.peak = options.peak === undefined ? defaults.peak : options.peak;
    }
    ...
    Pizzicato.Effects.Distortion = function (options) {
        ...
        this.gain = options.gain === undefined ? defaults.gain : options.gain;
    };
    ...
    Pizzicato.Effects.Distortion.prototype = Object.create(baseEffect, {
        ...
        adjustGain: {
            ...
            enumerable: false,
            value: function () {
                var gainValue = Pz.Util.isNumber(this.options.gain) ? parseInt(this.options.gain * 100, 10) : 50;
                var n_samples = 44100;
                ...
                for (var i = 0; i < n_samples; ++i) {
                    x = i * 2 / n_samples - 1;
                    curve[i] = (3 + gainValue) * x * 20 * deg / (Math.PI + gainValue * Math.abs(x));
                }
    ...
    Pizzicato.Effects.Flanger = function (options) {
        ...
        this.time = options.time === undefined ? defaults.time : options.time;
        this.speed = options.speed === undefined ? defaults.speed : options.speed;
        this.depth = options.depth === undefined ? defaults.depth : options.depth;
        this.feedback = options.feedback === undefined ? defaults.feedback : options.feedback;
        this.mix = options.mix === undefined ? defaults.mix : options.mix;
    };
    ...
    Pizzicato.Effects.StereoPanner = function (options) {
        ...
        this.pan = options.pan === undefined ? defaults.pan : options.pan;
    };
    ...
    Pizzicato.Effects.Reverb = function (options) {
        ...
        this.mix = options.mix === undefined ? defaults.mix : options.mix;
        this.time = options.time === undefined ? defaults.time : options.time;
        this.decay = options.decay === undefined ? defaults.decay : options.decay;
        this.reverse = options.reverse === undefined ? defaults.reverse : options.reverse;
    ...
    Pizzicato.Effects.DubDelay = function (options) {
        ...
        this.time = options.time === undefined ? defaults.time : options.time;
        this.mix = options.mix === undefined ? defaults.mix : options.mix;
        this.cutoff = options.cutoff === undefined ? defaults.cutoff : options.cutoff;
    };
    ...
    Pizzicato.Effects.DubDelay.prototype = Object.create(baseEffect, {
        ...
        cutoff: {
            ...
            set: function (cutoff) {
                ...
                this.bqFilterNode.frequency.value = cutoff;
            }
        }
    ...
    Pizzicato.Effects.RingModulator = function (options) {
        ...
        this.speed = options.speed === undefined ? defaults.speed : options.speed;
        this.distortion = options.distortion === undefined ? defaults.distortion : options.distortion;
        this.mix = options.mix === undefined ? defaults.mix : options.mix;
    };
    ...
    Pizzicato.Effects.Quadrafuzz = function (options) {
        ...
        this.lowGain = options.lowGain === undefined ? defaults.lowGain : options.lowGain;
        this.midLowGain = options.midLowGain === undefined ? defaults.midLowGain : options.midLowGain;
        this.midHighGain = options.midHighGain === undefined ? defaults.midHighGain : options.midHighGain;
        this.highGain = options.highGain === undefined ? defaults.highGain : options.highGain;
    };
    ...
    Pizzicato.Effects.Quadrafuzz.prototype = Object.create(baseEffect, {
        ...
        lowGain: {
            ...
            set: function (lowGain) {
                ...
                this.overdrives[0].curve = getDistortionCurve(Pz.Util.normalize(lowGain, 0, 150));
            }
        },
        ...
        midLowGain: {
            ...
            set: function (midLowGain) {
                ...
                this.overdrives[1].curve = getDistortionCurve(Pz.Util.normalize(midLowGain, 0, 150));
            }
        },
        ...
        midHighGain: {
            ...
            set: function (midHighGain) {
                ...
                this.overdrives[2].curve = getDistortionCurve(Pz.Util.normalize(midHighGain, 0, 150));
            }
        },
        ...
        highGain: {
            ...
            set: function (highGain) {
                ...
                this.overdrives[3].curve = getDistortionCurve(Pz.Util.normalize(highGain, 0, 150));
            }
        }
    });
